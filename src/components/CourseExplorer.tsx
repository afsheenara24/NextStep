    ...
    try {
      ...
      const transformedData: CourseInterface[] = (data || []).map((course) => ({
        ...
        specializations: Array.isArray(course.specializations)
          ? course.specializations.map((s) => String(s))
          : [],
        entrance_exams: Array.isArray(course.entrance_exams)
          ? course.entrance_exams.map((s) => String(s))
          : [],
        career_paths: Array.isArray(course.career_paths)
          ? course.career_paths.map((s) => String(s))
          : [],
        job_opportunities: Array.isArray(course.job_opportunities)
          ? course.job_opportunities.map((s) => String(s))
          : [],
        roadmap_stages: Array.isArray(course.roadmap_stages)
          ? course.roadmap_stages
          : [],
        colleges_offering: Array.isArray(course.colleges_offering)
          ? course.colleges_offering.map((s) => String(s))
          : [],
          ...
          <div className="text-center mb-8 animate-slide-up">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <Badge variant="outline" className="flex items-center gap-2">
                ...
                {selectedCourse.level === "post_10th"
                  ? "After 10th"
                  : "After 12th"}
              </Badge>
            </div>
          ...
          <Tabs defaultValue="overview" className="space-y-6">
            ...
            <TabsContent value="overview" className="space-y-6">
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    {formatFees(selectedCourse.fees_range)}
                  </p>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="roadmap">
              <CourseRoadmap
                stages={selectedCourse.roadmap_stages}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 animate-slide-up">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Discover comprehensive courses available after 10th and 12th grade
            with detailed career roadmaps
          </p>
        </div>
            ...
            >
              <CardHeader className="pb-3">
                <div className="flex justify-between items-start mb-2">
                  <Badge
                    variant={
                      course.level === "post_10th" ? "secondary" : "default"
                    }
                    className="mb-2"
                  >
